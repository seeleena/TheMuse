 ...
 */
$CONFIG->dataroot = "/data/elgg_data";
 ...
 *  This is the default user for the mysql container
 */
$CONFIG->dbuser = 'elgg_db_user';

/**
 * The database password
 *
 * @global string $CONFIG->dbpass
 * This is the password that was set as MYSQL_ROOT_PASSWORD for the docker container
 */
$CONFIG->dbpass = 'elgg_db_pass';
 ...
 * 
 * This points to the docker container 'db' (check docker-compose.yml for more info)
 */
$CONFIG->dbhost = 'mysql_elgg_db'; 
