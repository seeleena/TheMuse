<?php 
    ...
    $vars['sessionKey'] = getSessionKey($toolAcronym, $groupID, $assignmentID, "LAA"); 

    // Get the group members and add them to the variables array
    $vars['groupMembers'] = getGroupMembers($groupID, $assignmentID, $user); 

    // Generate the content of the page by rendering the 'Core/myTools/listAndApply/main' view
